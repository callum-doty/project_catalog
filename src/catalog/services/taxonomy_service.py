...
from catalog.models import KeywordTaxonomy, KeywordSynonym
        ...
        try:
            ...
            for row in rows:
                ...
                try:
                    ...
                    if row.get('synonyms'):
                        synonyms = [s.strip()
                                    for s in row['synonyms'].split(',') if s.strip()]
                        for syn in synonyms:
            ...
            for row in rows:
                if row.get('parent_term') and row.get('term'):
                    try:
                        ...
                        logger.error(
                            f"Error establishing relationship for {row.get('term')}: {str(e)}")
    ...
    def export_taxonomy_to_csv():
        ...
        try:
            ...
            for term in terms:
                ...
                synonyms = ', '.join(
                    [s.synonym for s in term.synonyms]) if term.synonyms else ''
        ...
        try:
            ...
            if existing_term:
                ...
                if synonyms:
                    ...
                    existing_synonyms = [
                        s.synonym for s in existing_term.synonyms]
            ...
            db.session.commit()
            logger.info(
                f"Created new taxonomy term: {term} ({primary_category})")
            return new_term
...
POLICY_ISSUES_TAXONOMY = [
    {"primary_category": "Policy Issues & Topics", "subcategory": "Economy & Taxes",
        "term": "Taxes", "synonyms": "tax cuts, tax reform, tax increases, taxation"},
    {"primary_category": "Policy Issues & Topics", "subcategory": "Economy & Taxes",
        "term": "Inflation", "synonyms": "price increases, cost of living, rising prices"},
    {"primary_category": "Policy Issues & Topics", "subcategory": "Economy & Taxes",
        "term": "Jobs", "synonyms": "employment, unemployment, job creation, workforce"},

    {"primary_category": "Policy Issues & Topics", "subcategory": "Social Issues",
        "term": "Abortion", "synonyms": "reproductive rights, pro-life, pro-choice, Roe v Wade"},
    {"primary_category": "Policy Issues & Topics", "subcategory": "Social Issues",
        "term": "LGBTQ+ Rights", "synonyms": "gay rights, transgender, same-sex marriage"},

    {"primary_category": "Policy Issues & Topics", "subcategory": "Healthcare",
        "term": "Medicare", "synonyms": "Medicare for All, senior healthcare"},
    {"primary_category": "Policy Issues & Topics", "subcategory": "Healthcare",
        "term": "Affordable Care Act", "synonyms": "Obamacare, ACA, healthcare reform"},

    {"primary_category": "Policy Issues & Topics", "subcategory": "Public Safety",
        "term": "Guns", "synonyms": "gun control, second amendment, firearms, gun violence"},
    {"primary_category": "Policy Issues & Topics", "subcategory": "Public Safety",
        "term": "Crime", "synonyms": "criminal justice, law and order, police"},

    {"primary_category": "Policy Issues & Topics", "subcategory": "Environment",
        "term": "Climate Change", "synonyms": "global warming, carbon emissions, paris agreement"},

    {"primary_category": "Policy Issues & Topics", "subcategory": "Education",
        "term": "Public Schools", "synonyms": "education funding, teachers, school choice"},

    {"primary_category": "Policy Issues & Topics", "subcategory": "Government Reform",
        "term": "Corruption", "synonyms": "drain the swamp, ethics, political corruption"},
]
