...
def upgrade():
    ...
    op.execute("DROP TABLE IF EXISTS _alembic_tmp_batch_jobs;")
    ...
    with op.batch_alter_table("documents", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column("preview_error_message", sa.Text(), nullable=True)
        )
        batch_op.add_column(
        ...
        if is_postgresql:
            batch_op.drop_index(
                "documents_embeddings_idx",
                postgresql_with={"lists": "100"},
                postgresql_using="ivfflat",
            )
            batch_op.drop_index(
                "ix_documents_search_vector_gin", postgresql_using="gin"
            )
    ...
    with op.batch_alter_table("extracted_text", schema=None) as batch_op:
        ...
        if is_postgresql:
            batch_op.drop_index(
                "ix_extracted_text_search_vector_gin", postgresql_using="gin"
            )
    ...
    with op.batch_alter_table("llm_analysis", schema=None) as batch_op:
        ...
        if is_postgresql:
            batch_op.drop_index(
                "ix_llm_analysis_search_vector_gin", postgresql_using="gin"
            )
            batch_op.drop_index(
                "llm_analysis_embeddings_idx",
                postgresql_with={"lists": "100"},
                postgresql_using="ivfflat",
            )
...
def downgrade():
    ...
    with op.batch_alter_table("llm_keywords", schema=None) as batch_op:
        batch_op.create_index(
            "ix_llm_keywords_llm_analysis_id", ["llm_analysis_id"], unique=False
        )
    ...
    with op.batch_alter_table("llm_analysis", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_llm_analysis_summary_description", ["summary_description"], unique=False
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            "ix_llm_analysis_election_year", ["election_year"], unique=False
        )
        batch_op.create_index(
            "ix_llm_analysis_document_tone", ["document_tone"], unique=False
        )
        batch_op.create_index(
            "ix_llm_analysis_document_id", ["document_id"], unique=False
        )
        batch_op.create_index(
            "ix_llm_analysis_campaign_type", ["campaign_type"], unique=False
        )
        batch_op.alter_column(
            "analysis_date",
            existing_type=sa.DateTime(timezone=True),
    ...
    with op.batch_alter_table("keyword_taxonomy", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_keyword_taxonomy_subcategory", ["subcategory"], unique=False
        )
        batch_op.create_index(
            "ix_keyword_taxonomy_primary_category", ["primary_category"], unique=False
        )
        batch_op.alter_column(
            "created_date",
            existing_type=sa.DateTime(timezone=True),
    ...
    with op.batch_alter_table("keyword_synonyms", schema=None) as batch_op:
        batch_op.create_index(
            "ix_keyword_synonyms_taxonomy_id", ["taxonomy_id"], unique=False
        )
    ...
    with op.batch_alter_table("extracted_text", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_extracted_text_supporting_text", ["supporting_text"], unique=False
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            "ix_extracted_text_main_message", ["main_message"], unique=False
        )
        batch_op.create_index(
            "ix_extracted_text_document_id", ["document_id"], unique=False
        )
        batch_op.alter_column(
            "extraction_date",
            existing_type=sa.DateTime(timezone=True),
    ...
    with op.batch_alter_table("entities", schema=None) as batch_op:
        batch_op.create_index(
            "ix_entities_opponent_name", ["opponent_name"], unique=False
        )
    ...
    with op.batch_alter_table("design_elements", schema=None) as batch_op:
        batch_op.create_index(
            "ix_design_elements_geographic_location",
            ["geographic_location"],
            unique=False,
        )
        batch_op.create_index(
            "ix_design_elements_document_id", ["document_id"], unique=False
        )
        batch_op.alter_column(
            "created_date",
            existing_type=sa.DateTime(timezone=True),
    ...
    with op.batch_alter_table("communication_focus", schema=None) as batch_op:
        batch_op.create_index(
            "ix_communication_focus_primary_issue", ["primary_issue"], unique=False
        )
        batch_op.create_index(
            "ix_communication_focus_document_id", ["document_id"], unique=False
        )
        batch_op.alter_column(
            "created_date",
            existing_type=sa.DateTime(timezone=True),
    ...
    with op.batch_alter_table("classifications", schema=None) as batch_op:
        batch_op.create_index(
            "ix_classifications_document_id", ["document_id"], unique=False
        )
