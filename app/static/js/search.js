        ...
        try {
            ...
            card.innerHTML = `
                ...
                <div class="p-6">
                    ...
                    <p class="text-sm text-gray-500 mb-4">Uploaded: ${doc.upload_date || 'Unknown date'}</p>
                    ...
                    ${doc.keywords && Array.isArray(doc.keywords) && doc.keywords.length ? `
                        <div>
...
function updatePagination(pagination) {
    try {
        ...
        // Calculate page range with explicit logic instead of using min/max
        let startPage = pagination.page - 2;
